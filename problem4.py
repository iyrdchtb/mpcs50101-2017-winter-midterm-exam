...
# given dollar amount.   Prompt the user to enter an amount.
# Take the input, calculate the tip and print out the inputed
# amount, tip and new total.  Use the following format:
#
